# Exploration into Weekly Spending - Going super fine to broad
...
## goal is to create first super broad including the tool medians, then go broader to just item-categories
## then to the 8 categories
